$VCE_extendTargetCount = -1;
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onActivate" TAB ", %player, %client, %pos, %vec";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onBlownUp" TAB ",%client, %player";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onBotActivated" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onBotDeath" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onBotTouch" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onDoorClose" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onDoorOpen" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onKeyMatch" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onKeyMismatch" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onMinigameReset" TAB ",%client";
//$VCE_extendTargetList[$VCE_extendTargetCount++] = "onPlayerTouch" TAB ",%player";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onPrintCountOverFlow" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onPrintCountUnderFlow" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onProjectileHit"  TAB ", %projectile,%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onRelay" TAB ",%client";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onRespawn" TAB ",%client, %player";
$VCE_extendTargetList[$VCE_extendTargetCount++] = "onTouchDown" TAB ",%client";
